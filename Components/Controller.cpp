...
void Controller::manageActionOnButton(const Button* button){
...
void Controller::toggleZoom(Deck* deckToZoom){
    ...
    animator.animateComponent(deckToUnZoom,boundsSmall.reduced (20),1,300,false,2,1);
    animator.animateComponent(deckToZoom,boundsBig.reduced (20),1,300,false,2,1);
